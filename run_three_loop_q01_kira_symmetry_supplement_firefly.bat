...
set "HELPER=examples\three_loop_q01_kira_symmetry_supplement_firefly_noniterative.py"
if not exist "%HELPER%" (
  echo ERROR: Q01 symmetry supplemental non-iterative FireFly helper was not found.
...
echo mode: supplemental targets only; iterative_reduction disabled; bunch_size=1
echo alt_dir: symmetry_supplement_firefly_v3_noniterative
echo NOTE: exact944closure1_firefly and earlier supplemental alt_dirs are not modified.
echo.
