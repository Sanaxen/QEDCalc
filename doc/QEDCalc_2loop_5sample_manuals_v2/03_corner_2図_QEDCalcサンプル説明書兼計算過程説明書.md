...
$$
(\mathcal I_4^{\rm raw},\mathcal I_5^{\rm raw})
\longrightarrow
(P_4,P_5)
\longrightarrow
\text{renormalized inner vertex}
\longrightarrow
\text{soft + hard + }z\text{ sectors}
\longrightarrow
A_{\rm C}
$$
...
\longrightarrow
\left(
\text{ordered electron momenta},
\text{photon labels},
\text{$q=0$ denominator powers},
\text{inner vertex subgraph}
\right)
$$
