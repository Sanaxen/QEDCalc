...
SOURCE = ROOT / "output" / "3loop_q01_modp_4line_expanded48_block_reduction.json"
OUTPUT = ROOT / "output" / "3loop_q01_modp_4line_expanded48_rhs_structure.json"
PHYSICAL_COUNT = 9
...
def main() -> None:
    ...
    if not reductions:
        raise RuntimeError("expanded48 reduction JSON contains no reductions")
    ...
    print("QEDCalc Q01 four-line expanded 48-block RHS structure")
    ...
    print("Q01 four-line expanded 48-block RHS structure PASS")
