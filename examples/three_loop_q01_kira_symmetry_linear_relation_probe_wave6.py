"""Re-run the Q01 symmetry relation probe with Fermat closure waves 1 through 6."""
...
from examples.three_loop_q01_kira_symmetry_relation_closure6_fermat import _find_export as _find_wave6_export
from examples.three_loop_q01_kira_910_exact_closure1_firefly_export_audit import PROJECT

COMBINED_FORM = PROJECT / "q01_symmetry_supplement_fermat_wave1_wave2_wave3_wave4_wave5_wave6_merged.inc"
...
def main() -> None:
    ...
    print("QEDCalc Q01 symmetry relation probe with Fermat closure waves 1+2+3+4+5+6")
    for i, path in enumerate(waves, 1):
        print(f"wave-{i} FORM export:", path)
    print("combined supplemental FORM export:", COMBINED_FORM)
    print("generic-rank zero-fill bugfix: built into base probe")
