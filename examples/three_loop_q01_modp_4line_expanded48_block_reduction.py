...
OUTPUT = ROOT / "output" / "3loop_q01_modp_4line_expanded48_block_reduction.json"
...
def main() -> None:
    ...
    print("QEDCalc Q01 four-line expanded 48-block mod-p reduction")
    ...
    print("Q01 four-line expanded 48-block mod-p reduction PASS")
