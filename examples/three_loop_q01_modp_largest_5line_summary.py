...
SOURCE = ROOT / "output" / "3loop_q01_modp_largest_5line_descent.json"


def main() -> None:
    data = json.loads(SOURCE.read_text(encoding="utf-8"))
    print("QEDCalc Q01 largest 5-line saved descent summary")
    ...
    print("Q01 largest 5-line saved descent summary PASS")
