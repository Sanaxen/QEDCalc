"""Re-run the Q01 symmetry relation probe with Fermat closure waves 1 through 4.

This wrapper also fixes generic-rank evaluation for basis entries absent from a
relation row by using SymPy Integer(0) instead of Python int 0.
"""
...
COMBINED_FORM = PROJECT / "q01_symmetry_supplement_fermat_wave1_wave2_wave3_wave4_merged.inc"
...
def main() -> None:
    ...
    print("QEDCalc Q01 symmetry relation probe with Fermat closure waves 1+2+3+4")
