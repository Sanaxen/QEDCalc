...
SOURCE = ROOT / "output" / "3loop_q01_modp_4line_expanded179_block_reduction.json"
OUTPUT = ROOT / "output" / "3loop_q01_modp_4line_expanded179_rhs_structure.json"
PHYSICAL_COUNT = 9
...
def main() -> None:
    ...
    print("QEDCalc Q01 four-line expanded 179-block RHS structure")
    ...
    print("Q01 four-line expanded 179-block RHS structure PASS")
